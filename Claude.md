...
Goal: A tool that takes PDF file uploads and sends them to the OpenAI API to extract primary metadata (e.g., title, author, year, state (if applicable), and key findings summary). 

Output: A .csv or Excel file with a table of each file's metadata.

Intended Users: Project Managers and Supports who are doing initial desk research and need to get a quick understanding of the existing research. They may be nontechnical or somewhat technical in terms of using programming languages.

**Key Features:**

1.  Multifile upload
2.  OpenAI API connection
3.  Autosave to a directory of the user's choosing
4.  Ability to choose which metadata to extract
